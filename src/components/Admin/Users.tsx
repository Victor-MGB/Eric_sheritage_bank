            ...
            {users.map((user) => (
              <div
                ...
                <div className="md:mb-0">
                  ...
                  <p className="text-sm text-gray-600 mb-1">Phone: {user.phoneNumber}</p>
                  ...
                  <p className="text-sm text-gray-600 mb-1">Account Type: {user.accountType}</p>
                  <p className="text-sm text-gray-600 mb-1">Address: {user.address}</p>
                  <p className="text-sm text-gray-600 mb-1">Postal Code: {user.postalCode}</p>
                  <p className="text-sm text-gray-600 mb-1">State: {user.state}</p>
                  <p className="text-sm text-gray-600 mb-1">Country: {user.country}</p>
                  <p className="text-sm text-gray-600 mb-1">Balance: {user.balance}</p>
                </div>
