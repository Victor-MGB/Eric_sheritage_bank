...
import { FaPhone, FaEnvelope, FaClock, FaFacebook, FaTwitter, FaLinkedin, FaCheckCircle } from "react-icons/fa";
...
const ContactCenter: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Post the form data
    try {
      const response = await axios.post("https://your-api-endpoint.com", JSON.stringify(formData), {
  ...
  return (
    <div
      className='container flex flex-col items-center justify-between h-screen mx-auto p-6 bg-cover bg-center bg-no-repeat'
        ...
        <div className='bg-black p-6 rounded-lg shadow-md bg-opacity-35'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='mb-4 flex flex-col'>
              ...
              ></textarea>
              {errorBooleans.messageBOL && <p className='text-red-800'>{errorFormMsG.messageError}</p>}
            </div>
