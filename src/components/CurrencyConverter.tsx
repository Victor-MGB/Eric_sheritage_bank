  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-lg mt-10">
      ...
      <p className="mb-8 text-center text-gray-700">
        ...
        user-friendly interface, our converter allows you to quickly and easily find the value of
        your currency in different countries. Whether you're traveling, trading, or just curious
        about the market, our tool provides accurate and up-to-date information to meet your needs.
        Simply select your base currency and explore the conversion rates for a wide range of
