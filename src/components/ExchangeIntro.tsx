...
const TravelInfoComponent: React.FC = () => {
	...
	return (
		...
		>
			<h1 className='text-4xl w-fit text-nowrap font-bold mb-8'>Travel with Ease when Banking with CCB</h1>
...
const CashWithdrawalsCard: React.FC<{ classStyle?: string }> = ({ classStyle }) => (
	...
	>
		...
		<p className='mb-4'>
			If CCB is your main bank account, make unlimited fee-free cash withdrawals abroad in the European
