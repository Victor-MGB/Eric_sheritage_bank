		...
		<footer className='bg-black text-white py-5 px-4 md:py-10'>
			...
			<div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 mt-10'>
				<div className={`flex flex-col`}>
					<h2 className='text-xl font-bold mb-4'>Sheritage Bank Bank</h2>
					<p>
					...
					<div className='flex mt-4 items-center justify-between w-[10rem] bg-yellow-500 rounded-lg p-[1rem]'>
						<a
...
const SubscriptionForm: React.FC = () => {
	return (
		<div className='bg-yellow-600 items-center p-2 h-[8rem] flex  justify-between '>
...
const BranchLocator: React.FC = () => {
	return (
		<div>
			<h3 className='text-lg font-bold mb-4 text-yellow-600'>Find Our Branch & ATM</h3>
			<form className='space-y-4'>
				...
				<button className='bg-yellow-700 text-white p-2 w-full'>Find on Map</button>
			</form>
		</div>
	);
};
...
const FooterLinks: React.FC = () => {
	return (
		<div className='grid grid-cols-2 gap-6'>
			<div>
				<h3 className='text-lg font-bold mb-4 text-yellow-600'>Explore</h3>
				<ul>
					<li>
