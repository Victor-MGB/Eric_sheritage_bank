      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 mt-4 animate__animated animate__fadeIn">
            You'll save time and money and gain control of your accounts. You can watch where every penny goes, whether you're saving enough money for retirement, and you can set goals and track your progress. Plus, you can sync your MoneyCentral to accounts at nearly 14,000 financial institutions, so you can keep track of everything in one place.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="md:pr-8 animate__animated animate__fadeInLeft">
            ...
            <ul className="list-disc list-inside space-y-2 text-lg text-gray-700">
              ...
              <li><span className="font-bold">Net Worth:</span> Manage assets and debts and see your net worth at glance</li>
